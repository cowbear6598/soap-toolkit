...
python3 <skill-dir>/scripts/list.py --project DCM --status "In Progress"

# 取得單張 Issue
python3 <skill-dir>/scripts/get.py --issue DCM-1690

# 建立 Bug（帶描述）
python3 <skill-dir>/scripts/create.py --project DCM --summary "Safari 無法登入" --description "Safari 15+ 點擊登入無反應" --issue-type Bug

# 在父 Issue 下建立子任務
python3 <skill-dir>/scripts/create.py --project DCM --summary "實作驗證邏輯" --issue-type Subtask --parent DCM-3923

# 切換狀態
python3 <skill-dir>/scripts/transition.py --issue DCM-1690 --status "In Progress"

# 新增評論
python3 <skill-dir>/scripts/comment.py --issue DCM-1690 --comment "已確認問題，預計明天修復"
```
